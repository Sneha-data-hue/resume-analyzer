...
# ---------- CSV STORAGE (FOR POWER BI) ----------
def save_to_csv(job_role, score, ats_score, matched, missing):
    data = {
        "Job Role": job_role,
        "Match Score": score,
        "ATS Score": ats_score,
    ...
    if os.path.exists("history.csv"):
        old_df = pd.read_csv("history.csv")
...
if uploaded_file:
    ...
    # SAVE TO CSV (POWER BI)
    save_to_csv(job_role, score, ats_score, matched, missing)
